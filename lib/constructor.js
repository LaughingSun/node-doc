 ...
 */
function constructor (options, comments, exports, namespaces) {
  var doc = {
    name: options.name
  };
  ...
  if (keys.length !== 0) {
    keys.forEach(function (key) {
      ...
      if (ns.todos) throw new Error('Add todos to doc obj');
    });
  }
...
/**
 * Parses a author from the package.json that follows "Author Name <email@address.com> (https://website.com)"
 *
 ...
 * @return [email]   {String} Email address of the author.
 * @return [website] {String} Website of the author.
 */
