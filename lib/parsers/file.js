...
/**
 * @title Parse file
 * @desc Parse an file into an array of comment objects.
 * @public
 *
...
function parseFile (lines) {
  ...
  lines.forEach(function (line, i) {
    if (commentStart === -1) {
      ...
      if (line.indexOf('*/') > -1) {
        comments.push({start: commentStart + 1, end: i});
  ...
  comments.forEach(function (comment, i) {
    ...
    comments[i] = commentParser(commentLines, info);
  });
...
/**
 * @title Detect code information
 * @desc Get information from lines of code in an array.
 * @private
 *
...
/**
 * @title Detect variable type
 * @desc Detect the type of the variable.
 * @private
 *
