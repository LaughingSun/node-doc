...
function parseTag (tag) {
  ...
  switch (type) {
    ...
    case 'this':
      ...
      if (tag.type && !tag.name) throw new Error('Can\'t have a type for the this object');
      if (!tag.name && !tag.desc && !tag.type) throw new Error('Requires an description or name');
      break;
 ...
 * @param  name   {Boolean} False makes name a part of the description, true enforces an name.
